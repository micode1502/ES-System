                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="card-body p-4">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" id="btnAdd">
    ...
    <script>
        ...
        $('#table-list').on('click', '.action', function() {
            ...
            if (op == 'edit') {
                $.ajax({
                    method: 'GET',
                    url: `{{ url('appointment') }}/${id}/edit`,
                    success: function(res) {
                        $('#modal').find('.modal-content').html(res);
                        $("#modalTitle").text("{{__('Update appointment')}}");
        ...
        $('#btnAdd').on('click', function() {
            $.ajax({
                ...
                success: function(res) {
                    $('#modal').find('.modal-content').html(res);
                    $("#modalTitle").text("{{__('Register appointment')}}");
