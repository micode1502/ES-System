...
<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
    ...
    <!-- Modal body -->
    <form action="{{ $user->id ? route('user.update', $user) : route('user.store') }}" class="p-4 md:p-5" id="formModal"
        ...
        <div class="grid gap-4 mb-4 grid-cols-2">
            <div class="col-span-2">
                <div class="grid gap-4 grid-cols-1">
                    <div>
                        <label for="role" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Rol') }}</label>
            ...
            <div class="col-span-1">
                <div class="grid gap-4 grid-cols-1">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ $user->id ? $user->name : '' }}"
                    ...
                    <div>
                        <label for="lastname"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Apellido') }}</label>
                        <input type="text" name="lastname" id="lastname"
                            value="{{ $user->id ? $user->lastname : '' }}" placeholder="Ingresar Apellido"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            required="">
                    </div>
                </div>
            ...
            <div class="col-span-1">
                <div class="grid gap-4 grid-cols-1">
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="{{ $user->id ? $user->email : '' }}"
