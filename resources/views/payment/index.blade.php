    ...
    <script>
        ...
        $('#table-list').on('click', '.action', function() {
            ...
            if (op == 'print') {
                $.ajax({
                    method: 'GET',
                    url: `{{ url('payment') }}/${id}/print`,
                    success: function(res) {
                        window.open(`{{ url('payment') }}/${id}/print`, '_blank');
                    }
                });
            }
            if (op == 'edit') {
                $.ajax({
                    method: 'GET',
                    url: `{{ url('payment') }}/${id}/edit`,
                    success: function(res) {
                        $('#modal').find('.modal-content').html(res);
                        $("#modalTitle").text("{{__('Actualizar Pago')}}");
        ...
        $('#btnAdd').on('click', function() {
            $.ajax({
                ...
                success: function(res) {
                    $('#modal').find('.modal-content').html(res);
                    $("#modalTitle").text("{{__('Registrar Pago')}}");
